...
import { EditComponent } from './components/atoms/edit-icon/edit.component';
import { ModalAdminUserComponent } from './shared-components/modal-add-user/modal-add-user.component';
